...
function genId(): string {
  return `cad-${Date.now().toString(36)}-${Math.random().toString(36).slice(2, 6)}`;
}
...
export default function CompanyAdsScreen() {
  ...
  const [ads, setAds] = useState<Ad[]>(initialCompanyAds);
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      try {
        const remote = await listAdsByOwner("company", ownerUid);
        if (cancelled) return;
      ...
      <FlatList
        ...
        ListEmptyComponent={
          <EmptyState
            ...
            description="أنشئ إعلانك الأول وروّج لمنتجات شركتك لجذب المزيد من العملاء"
            actionLabel="+ إنشاء إعلان"
            onAction={openCreate}
            testID="company-empty-ads"
          />
        }
        renderItem={({ item }) => (
...
function AdCard({
  ...
  return (
    <View style={styles.card} testID={`company-ad-${ad.id}`}>
      ...
      >
        <View style={styles.modalCard}>
          <View style={styles.modalHeader}>
            <TouchableOpacity
              testID="company-ads-create-close"
              onPress={handleClose}
          ...
          >
            ...
            <Field
              ...
              placeholder="مثال: عرض خاص على قطع الغيار"
              testID="company-ads-field-title"
            />
            ...
            <View style={{ flexDirection: "row", gap: spacing.md }}>
              <View style={{ flex: 1 }}>
                <Field
                  ...
                  testID="company-ads-field-start"
                />
              </View>
              <View style={{ flex: 1 }}>
                <Field
            ...
            <View style={styles.featuredRow}>
              ...
              <Switch
                testID="company-ads-field-featured"
                value={isFeatured}
          ...
          <View style={styles.modalFooter}>
            <TouchableOpacity
              testID="company-ads-create-save"
